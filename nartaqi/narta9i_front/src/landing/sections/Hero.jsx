...
export default function Hero() {
  ...
  return (
    <section className="l-hero" id="hero" style={{ backgroundImage: bg ? `linear-gradient(135deg, rgba(15,23,42,0.85) 0%, rgba(15,23,42,0.9) 100%), url(${bg})` : `linear-gradient(135deg, rgba(15,23,42,0.92) 0%, rgba(15,23,42,0.95) 100%)` }}>
      <div className="l-hero-particle" style={{ width: 300, height: 300, top: '10%', right: '5%', background: 'rgba(212,160,23,0.08)' }} />
      <div className="l-hero-particle" style={{ width: 200, height: 200, bottom: '15%', left: '10%', background: 'rgba(30,64,175,0.08)', animationDelay: '3s' }} />
