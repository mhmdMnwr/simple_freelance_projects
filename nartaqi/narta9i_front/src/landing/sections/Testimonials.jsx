    ...
    <section className="l-testimonials" id="testimonials" style={{ padding: '80px 0', background: 'var(--white)' }}>
      <div className="l-container">
        <div className="l-testimonials-header fade-up" style={{ textAlign: 'center', marginBottom: 40 }}>
          <span className="l-section-label">آراء حول المنصة</span>
          <h2 className="l-section-heading">آراء التلاميذ</h2>
          <p className="l-testimonials-sub" style={{ color: 'var(--text-muted)', marginTop: 8 }}>نعتز بشهاداتكم ونفخر بثقتكم بنا.</p>
        </div>
        
        {images.length === 0 ? (
          <div className="fade-up" style={{ textAlign: 'center', color: 'var(--text-muted)', padding: '40px 0' }}>
            لا توجد آراء حالياً
          </div>
        ) : (
          <div className="l-ann-carousel fade-up" style={{ paddingBottom: '30px' }}>
            ...
            <div className="l-ann-slide" key={current} style={{ cursor: 'default', background: 'var(--gray-100)', display: 'flex', justifyContent: 'center', borderRadius: 'var(--radius)' }}>
              {images[current] && (
                <img 
